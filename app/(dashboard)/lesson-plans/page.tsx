    ...
    <div className="animate-[fadeIn_0.3s_ease-out]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">NCERT-aligned, differentiated lesson plans in seconds</p>
        </div>
          ...
          <div className="lg:col-span-3">
            {generating ? (
              ...
              <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-12 text-center">
                ...
                <p className="text-sm text-slate-500 max-w-sm mx-auto mb-6">Select class, subject, chapter, pick a teaching method and duration — AI generates a complete, differentiated, NCERT-aligned lesson plan.</p>
